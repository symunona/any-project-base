...
function LogoBrand({ projectName, projectBadge }: { projectName: string; projectBadge?: string | undefined }) {
  return (
    <>
    ...
    <>
      ...
      >
        <div className="h-16 flex items-center gap-2 px-6">
          <LogoBrand projectName={projectName} projectBadge={projectBadge} />
        </div>
